...
export function ProjectCulture() {
  ...
  useEffect(() => {
    document.title = lang === 'ENG' ? "Howard Lee - Culture_Identity_Boundary" : "Howard Lee - 文化_身分_邊界";
  }, [lang]);

  const images = [
    { src: '/projects/culture/book_cover.jpg', alt: 'Cover' },
    { src: '/projects/culture/book1.jpg', alt: 'Zine 1' },
    { src: '/projects/culture/book2.jpg', alt: 'Zine 2' },
    { src: '/projects/culture/book3.jpg', alt: 'Zine 3' },
    { src: '/projects/culture/book4.jpg', alt: 'Zine 4' },
    { src: '/projects/culture/book5.jpg', alt: 'Zine 5' },
    { src: '/projects/culture/book6.jpg', alt: 'Zine 6' },
    { src: '/projects/culture/book7.jpg', alt: 'Zine 7' },
    { src: '/projects/culture/book8.jpg', alt: 'Zine 8' }
  ];
        ...
        <div className="w-full md:w-1/3 md:sticky md:top-[100px] self-start">
          ...
          <div className="flex flex-col gap-8 font-['Geist_Mono'] text-base uppercase tracking-[1px] mb-8 pb-8 border-b border-black/10">
            ...
            <div className="flex">
              ...
              <span className="flex-1 leading-[1.8]">{lang === 'ENG' ? <>Editorial Design /<br />Graphic Design</> : '圖文設計 / 平面設計'}</span>
            </div>
            <div className="flex">
              <span className="opacity-50 w-28 shrink-0 md:w-32">{lang === 'ENG' ? 'Materials' : '媒材'}</span>
              <span className="flex-1">{lang === 'ENG' ? 'Photoshop, Illustrator, Indesign' : 'Photoshop、Illustrator、Indesign'}</span>
            </div>
            <div className="flex">
              <span className="opacity-50 w-28 shrink-0 md:w-32">{lang === 'ENG' ? 'Course' : '課程'}</span>
              <span className="flex-1">{lang === 'ENG' ? 'Introduction to Design' : '設計概論'}</span>
            </div>
          </div>
