...
export function ProjectBamboo() {
  ...
  const images = [
    ...
    { src: '/projects/bamboo/realscene1.jpg', alt: 'Realscene 1' },
    { src: '/projects/bamboo/realscene2.jpg', alt: 'Realscene 2' },
    { src: '/projects/bamboo/realscene3.jpg', alt: 'Realscene 3' },
    { src: '/projects/bamboo/realscene4.jpg', alt: 'Realscene 4' },
    { src: '/projects/bamboo/realscene5.jpg', alt: 'Realscene 5' },
    { src: '/projects/bamboo/realscene7.jpg', alt: 'Realscene 7' },
    ...
    <div className="pt-[40px] md:pt-[60px] pb-[100px] min-h-screen relative">
      <div className="flex flex-col md:flex-row gap-10 md:gap-20 mb-20">
        ...
        <div className="w-full md:w-1/3 md:sticky md:top-[100px] self-start">
          ...
          <h1 className={`font-['Space_Grotesk'] ${lang === 'ENG' ? 'text-[2.5rem] md:text-[3rem]' : 'text-[3rem] md:text-[3.5rem]'} leading-[1.2] tracking-[-2px] mb-16 md:mb-20 -ml-[0.04em]`}>
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="columns-1 md:columns-2 gap-[30px] space-y-[30px]">
            {images.slice(1).map((img, i) => (
              ...
              >
                <img src={img.src} alt={img.alt} className="w-full h-auto block transition-transform duration-[2s] ease-[cubic-bezier(0.25,0.8,0.25,1)] group-hover:scale-105 hover:opacity-80 pointer-events-none" />
              </div>
            ))}
          </div>
        </div>
