...
export function ProjectEndowing() {
  ...
  useEffect(() => {
    document.title = lang === 'ENG' ? "Howard Lee - The Endowing of Objects" : "Howard Lee - 物體的賦予";
  }, [lang]);

  const images = [
    { src: '/projects/endowing/book_cover.jpg', alt: 'Cover' },
    { src: '/projects/endowing/book1.jpg', alt: 'Zine 1' },
    { src: '/projects/endowing/book2.jpg', alt: 'Zine 2' },
    { src: '/projects/endowing/book3.jpg', alt: 'Zine 3' },
    { src: '/projects/endowing/book4.jpg', alt: 'Zine 4' },
    { src: '/projects/endowing/book5.jpg', alt: 'Zine 5' },
    { src: '/projects/endowing/book6.jpg', alt: 'Zine 6' }
  ];
        ...
        <div className="w-full md:w-1/3 md:sticky md:top-[100px] self-start">
          ...
          <div className="flex flex-col gap-8 font-['Geist_Mono'] text-base uppercase tracking-[1px] mb-8 pb-8 border-b border-black/10">
            ...
            <div className="flex">
              ...
              <span>{lang === 'ENG' ? 'Editorial Design / Graphic Design' : '圖文設計 / 平面設計'}</span>
            </div>
            <div className="flex">
              <span className="opacity-50 w-28 shrink-0 md:w-32">{lang === 'ENG' ? 'Materials' : '媒材'}</span>
              <span className="flex-1">{lang === 'ENG' ? 'Photoshop, Illustrator, Indesign, Blender' : 'Photoshop、Illustrator、Indesign、Blender'}</span>
            </div>
            <div className="flex">
              <span className="opacity-50 w-28 shrink-0 md:w-32">{lang === 'ENG' ? 'Course' : '課程'}</span>
              <span className="flex-1 leading-[1.8]">{lang === 'ENG' ? 'Introduction to Design' : '設計概論'}</span>
            </div>
          </div>
